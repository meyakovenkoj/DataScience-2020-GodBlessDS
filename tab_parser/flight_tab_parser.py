...
TAKE_COL_NUM = [2, 3, 4, 5, 6, 7, 8, 9 ] # DepartDate;DepartTime;ArrivalDate;ArrivalTime;Flight;CodeSh;From;Dest;

if __name__ == "__main__":

        file_desc = open('orig_data/Sirena-export-fixed.tab', 'r', encoding='UTF8')

        new_file_desc = open('orig_data/out/Sirena-export-fixed-flight.csv','w', encoding='UTF8')
