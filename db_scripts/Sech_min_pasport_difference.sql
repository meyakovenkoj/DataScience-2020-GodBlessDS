use GodBlessDS
SELECT DISTINCT cu1.PassengerFirstName,cu1.PassengerLastName,cu1.PassengerBirthDate,
...
AND cu2.PassengerDocumentN!=cu1.PassengerDocumentN
AND ABS(cu2.PassengerDocumentN-cu1.PassengerDocumentN)<100
JOIN csv_ticket ct2 
